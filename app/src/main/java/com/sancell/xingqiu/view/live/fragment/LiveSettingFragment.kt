...
import com.sancell.xingqiu.constants.img.ImgUpLoadManager
import com.sancell.xingqiu.constants.utils.PreferencesUtils
import com.sancell.xingqiu.dialog.ComfirmToDialog
import com.sancell.xingqiu.dialog.InvitationDatePickerDialog
import com.sancell.xingqiu.dialog.LiveDefinitionSelectDialog
import com.sancell.xingqiu.dialog.LiveIssueSucessDialog
import com.sancell.xingqiu.entity.live.LiveInitData
import com.sancell.xingqiu.entity.live.LiveIntitParInfo
...
import com.sancell.xingqiu.interfaces.OnComfirmLinsenr
...
import com.sancell.xingqiu.utils.DialogUtil
import com.sancell.xingqiu.utils.PublishParamUtils
import com.sancell.xingqiu.utils.TimeUtil
 ...
 * 直播设置
 */
class LiveSettingFragment : BaseDataFragmentKt<LiveViewModel>() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (mPictures != null && mPictures.size > 0) {
                ...
                mImgUpLoadManager?.uploadImageSelect("1103", mBatchId, mPictures.get(0), object :
                    OnImagUpLoadLinsener {
