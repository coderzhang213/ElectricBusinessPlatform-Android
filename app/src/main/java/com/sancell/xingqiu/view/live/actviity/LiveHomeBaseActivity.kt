...
import com.sancell.xingqiu.view.live.help.LivePlayStatusManager

abstract class LiveHomeBaseActivity<VM : BaseViewModel> : BaseDataActivityKt<VM>(),
    OnGetLivePalyStatusLinsener, OnBackPressedRegLinsenr {
