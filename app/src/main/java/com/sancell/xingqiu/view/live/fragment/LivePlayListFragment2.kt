...
import com.sancell.xingqiu.entity.live.RecomLiveParInfo
import com.sancell.xingqiu.enump.LiveStatusEnum
import com.sancell.xingqiu.interfaces.OnAddRecommendLinsener
import com.sancell.xingqiu.interfaces.OnGetLivePalyStatusLinsener
import com.sancell.xingqiu.mvvm.viewmodel.LiveViewModel
import com.sancell.xingqiu.utils.RxTimerUtil
import com.sancell.xingqiu.view.live.adapter.LivePlayItemAdapter2
import kotlinx.android.synthetic.main.activit_live_list_layout2.*

/**
 * 直播播放列表
 */
class LivePlayListFragment2 : BaseDataFragmentKt<LiveViewModel>(), OnAddRecommendLinsener {
