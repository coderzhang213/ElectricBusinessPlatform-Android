...
import com.sancell.xingqiu.dialog.TxFilterDialog;
...
import com.sancell.xingqiu.interfaces.OnOpenInputMsgLinsener;
import com.sancell.xingqiu.view.live.fragment.base.LiveCaptureToolBaseFragment;
...
public class TengXunCameraPusherFragment extends LiveCaptureToolBaseFragment implements ITXLivePushListener,
        PusherSettingFragment.OnSettingChangeListener, PusherMoreFragment.OnMoreChangeListener, OnOpenInputMsgLinsener, PusherBGMFragment.OnBGMControllCallback, TXLivePusher.OnBGMNotify {
...
//        }
    ...
    public void sendMsg() {
        ...
        if (mOnActivityUiLinsenr != null) {
            mOnActivityUiLinsenr.showInputPanel();
        }
    }
/////////////////////////////////////////////////////////////////////////////////
    //
