...
import com.sancell.xingqiu.entity.live.LiveFollowComInfo
 ...
 * 关联商品列表
 */
class HomeLiveVideoGoodsAdapter(data: List<LiveFollowComInfo>) : BaseQuickAdapter<LiveFollowComInfo, BaseViewHolder>(
    R.layout.recycle_live_video_goods, data) {
    ...
    override fun convert(helper: BaseViewHolder, item: LiveFollowComInfo) {
        ...
        ImageLoaderUtils.loadRoundImage(mContext, item.coverPicThumb, iv_video_goods, MyScreenUtils.dip2px(mContext,4f))
