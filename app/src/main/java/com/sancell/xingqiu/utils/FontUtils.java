...
public class FontUtils {
    ...
    public SpannableStringBuilder changeTextSize(
        ...
        while (i < length) {
            ...
            builder.setSpan(new AbsoluteSizeSpan(MyScreenUtils.sp2px(context, textSize)), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            i++;
        }
        return builder;
    }
    ...
    public SpannableStringBuilder changeTextSizeColor(
        ...
        for (String changeText : changeTextArray) {
            ...
            builder.setSpan(new AbsoluteSizeSpan(MyScreenUtils.sp2px(context, textSize)), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            builder.setSpan(new ForegroundColorSpan(MyScreenUtils.sp2px(context, textColor)), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
