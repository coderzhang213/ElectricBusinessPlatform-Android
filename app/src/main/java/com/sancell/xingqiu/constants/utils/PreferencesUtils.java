...
public class PreferencesUtils {
    ...
    public static void put(@NonNull String key, @NonNull Object value) {
        put(BaseApplication.Companion.getInstance(), key, value);
    }
    ...
    public static Object get(String key, Object defaultValue) {
        return get(BaseApplication.Companion.getInstance(), key, defaultValue);
    }
    ...
    public static int getInt(String key, int defaultValue) {
        SharedPreferences sp = BaseApplication.Companion.getInstance().getSharedPreferences(FILE_NAME,
                MODE_PRIVATE);
